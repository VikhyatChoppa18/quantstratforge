...
@st.cache_resource
def init_components():
    return DataFetcher(), StrategyGenerator(), Backtester(ticker=ticker)

data_fetcher, generator, backtester = init_components()
...
if st.button("Run Backtest"):
    with st.spinner("Running backtest..."):
        try:
            # Run backtest
            results = backtester.backtest(strategy_code_input)
...
st.markdown("For licensing inquiries, contact: Venkata Vikhyat Choppa <vikkychoppa@gmail.com>")
